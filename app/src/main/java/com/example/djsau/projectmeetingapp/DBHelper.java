...
public class DBHelper extends SQLiteOpenHelper{
    ...
    public void onCreate(SQLiteDatabase db) {
        ...
        if(TABLE_NAME.equals("meeting_table")) {
            db.execSQL( "create table " + TABLE_NAME + " (ID INTEGER PRIMARY KEY AUTOINCREMENT," + "TITLE TEXT,NOTES TEXT, DATE TEXT, TIME TEXT, LATITUDE TEXT, LONGITUDE TEXT, ATTENDEES TEXT)");
        }
        else{
